  ...
  return (
    <>
      ...
      <div className="flex justify-start">
        ...
        {/* right side section */}
        <div className="w-[90%] m-auto h-[41vw] sm:m-0 md:m-0 md:w-[90%] md:px-2 mt-0">
          {/* top title */}
          <div className="flex justify-between px-1 mt-12 sm:mt-5 sm:flex-col sm:gap-y-2 md:flex-col md:gap-y-2">
            <h1 className="text-3xl font-bold sm:text-sm md:text-md">Group Management</h1>
            {/* search bar */}
            <div className="flex gap-1 sm:flex-col sm:gap-y-1 md:flex-col md:gap-y-2">
              <div className="flex justify-center items-center  border border-borderOutlineColor-900 rounded-md bg-white text-[#3c3c3c]">
                <input
                  ...
                  className="px-3 py-2 rounded-lg outline-none focus:outline-none text-sm w-[250px] sm:w-[100%] sm:px-2 sm:py-2 sm:text-sm md:w-[100%] md:px-2 md:py-3 md:text-2xl"
                />
              ...
              <table className="min-w-full">
                ...
                <thead>
                  <tr>
                    ...
                    <th className="text-center  sticky top-0  bg-white border-gray-200  px-4 md:text-xl">
                      Total Members
                    </th>
                    <th className=" text-center  max-w-[450px] sticky top-0 bg-white border-gray-200 md:text-xl">
                      Members Name
                    </th>
                  
                    <th className="px-2 text-center  sticky top-0 bg-white md:text-xl">
                      Action
                    </th>
                  </tr>
                </thead>
