                  ...
                  <tr className="text-center">
                    ...
                    <td className="px-4 py-4">
                      <div className="flex gap-2">
                        ...
                        <span className="md:text-lg lg:text-2xl">Devon Lane </span>
                      </div>
                    </td>

                    {/* admin email id */}
                    <td className=" py-2 text-left px-4 lg:text-2xl">
                      debra.holt@exaple.com
                    </td>
                    <td className=" px-4 py-2 md:text-lg lg:text-2xl">(406) 555-0120</td>
                    <td className=" px-4 py-2 md:text-lg lg:text-2xl">3467895768</td>

                    <td className=" px-4 py-2 md:text-lg lg:text-2xl">Student</td>

                    <td className="px-4 py-2 sm:px-0 sm:py-0 md:text-lg md:px-0 md:py-0 lg:px-0 lg:py-0">
                      <div className="flex justify-center gap-2 sm:gap-1 sm:flex-col sm:gap-y-3  sm:items-center md:gap-1 md:flex-col md:gap-y-3  md:items-center lg:flex-col lg:items-center">
                        ...
                        <img
                          src={deleteIcon}
                          alt="edit icon"
                          className="mr-2 text-[#4E493E] hover:text-red-800 cursor-pointer sm:w-[20px] sm:mr-0 sm:ml-0 md:w-[20px] md:ml-0 md:mr-0 lg:w-[30px]"
                        />
                      </div>
                    </td>
                  </tr>
