        ...
        <div className="relative w-full max-w-4xl mx-auto rounded-lg overflow-hidden sm:w-[90vw] md:w-[90vw] lg:w-[92vw]">
          <div className="relative bg-white  rounded-lg shadow-md pb-2">
            <div className="flex justify-between items-center  bg-blue-900 py-2">
              ...
              <button onClick={() => onClose(false)} className="text-red text-white  hover:text-gray-900 hover:outline-none border-none outline-none bg-blue-900 text-lg">
                <IoMdClose />
              </button>
            </div>
            ...
            <div className="flex justify-end mr-9 gap-2 sm:mr-0 sm:justify-center">
              ...
              <button onClick={() => onClose(false)} className="border border-black bg-white  text-black font-semibold rounded-lg focus:outline-none">
                cancel
              </button>
            </div>
          </div>
