  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto bg-black bg-opacity-50">
        <div className="h-[600px] overflow-y-auto mt-6 sm:h-[80vh] mainFormSection md:h-auto lg:h-auto">
          <div className="relative w-[100%] max-w-[55vw] sm:max-w-[100vw] md:max-w-[75vw] lg:max-w-[85vw] mx-auto rounded-lg overflow-hidden sm:w-[90vw] md:w-[90vw] lg:w-[96vw]">
            <div className="relative w-full bg-white rounded-lg shadow-md pb-2">
              ...
              <div className="p-8 flex flex-col gap-y-4 w-full">
                ...
                <div className="flex flex-wrap list-none mt-6 gap-6">
                  <div className="flex flex-col w-[23%] gap-y-2 sm:w-[100%] md:w-[47%] lg:w-[30%]">
                    <h6 className="text-blue-300 text-sm"> Authentication Code{" "} <span className="text-red-500 pl-1">*</span></h6>
                    <input type="text" name="Authentication_Code" placeholder="385555" className="input" />
                  </div>
                  <div className="flex flex-col w-[23%] gap-y-2 sm:w-[100%] md:w-[47%] lg:w-[30%]">
                  ...
                  <div className="flex flex-col w-[23%] gap-y-2 sm:w-[100%] md:w-[47%] lg:w-[30%]">
                    <h6 className="text-blue-300 text-sm">Gender<span className="text-red-500 pl-1">*</span> </h6>
                  ...
                  <div className="flex flex-col w-[23%] gap-y-2 sm:w-[100%] md:w-[47%] lg:w-[30%]">
                    <h6 className="text-blue-300 text-sm">Email Id<span className="text-red-500 pl-1">*</span></h6>
                    <input type="text" name="Authentication_Code" className="input" />
                  </div>

                  <div className="flex flex-col w-[23%] gap-y-2 sm:w-[100%] md:w-[47%] lg:w-[30%]">
                    <h6 className="text-blue-300 text-sm">Contact No<span className="text-red-500 pl-1">*</span></h6>
                    <input type="text" name="Authentication_Code" className="input" />
                  </div>

                  <div className="flex flex-col w-[23%] gap-y-2 sm:w-[100%] md:w-[47%] lg:w-[30%]">
                    <h6 className="text-blue-300 text-sm">DOB</h6>
                    <input type="date" name="Authentication_Code" className="input" />
                  </div>
                  ...
                  <div className="flex flex-col w-[23%] gap-y-2 sm:w-[100%] md:w-[47%] lg:w-[30%]">
                    <h6 className="text-blue-300 text-sm">Address<span className="text-red-500 pl-1">*</span></h6>
                    <input type="text" name="Authentication_Code" className="input" />
                  </div>
                ...
                <div className="flex text gap-3 mt-3 sm:flex-col">
                  <span className="text-md font-medium text-blue-300 pt-2">Relative Details</span>
                  <button className="flex justify-center text-center gap-3 bg-blue-900 text-white" onClick={openAddRelativeModal}>
                    <i className="text-lg pt-1"> <IoIosAddCircleOutline /></i>{" "} Add Relative
                  </button>
                </div>
              </div>
              ...
              <div className="flex justify-end mr-9 gap-2 sm:mr-0 sm:justify-center">
                ...
                <button onClick={onClose} className="border border-black bg-white text-black font-semibold rounded-lg focus:outline-none">Cancel</button>
              </div>
            </div>
          </div>
        </div>
