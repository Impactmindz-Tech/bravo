      ...
      <div className="flex justify-start">
        ...
        <div className="w-[90%] m-auto h-[41vw] sm:m-0  md:m-0 md:w-[90%] md:px-2">
          ...
          <div className="flex justify-between px-1 mt-12 sm:mt-5 sm:flex-col sm:gap-y-2 md:flex-col md:gap-y-2">
            <h1 className="text-3xl font-bold sm:text-sm md:text-md">User Management</h1>
            {/* search bar */}
            <div className="flex gap-1 sm:flex-col sm:gap-y-1 md:flex-col md:gap-y-2">
              <div className="flex justify-center items-center border border-[#ccc] rounded-md bg-white text-[#3c3c3c] ">
                <input
                  ...
                  name="search"
                  placeholder="Search"
                  className="px-3 py-2 rounded-lg outline-none focus:outline-none text-md w-[270px] sm:w-[100%] sm:px-2 sm:py-2 sm:text-sm md:w-[100%] md:px-2 md:py-3 md:text-2xl"
                />
              ...
              {/* filter btn */}
              <button className="bg-blue-300 flex justify-center gap-8 text-sm text-white hover:border-[#ccc] sm:gap-2 md:gap-2 md:text-xl sm:text-sm">
                Filter
              ...
              <table className="min-w-full">
                ...
                <thead>
                  <tr>
                    ...
                    <th className=" text-center md:text-xl sticky top-0 bg-white border-gray-200 md:px-2">
                      Contact No
                    </th>
                    <th className=" text-center md:text-xl sticky top-0 bg-white border-gray-200 w-[150px] px-9 sm:w-auto sm:px-3">
                      Authentication Code
                    </th>
                    ...
                    <th className="px-2 text-center  sticky top-0 md:text-xl bg-white">
                      Action
                    </th>
                  </tr>
                </thead>
                  ...
                  <tr className="text-center">
                    ...
                    <td className="px-4 py-4 ">
                      <div className="flex gap-2 ">
                        ...
                        <span className="text-xl">Devon Lane </span>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-2 md:text-xl">3467895768</td>
                    ...
                    <td className="px-4 py-2 capitalize md:text-xl">student</td>
                    <td className="px-4 py-2 capitalize text-lg md:text-xl">
                      <div
                    ...
                    <td className="px-4 py-2 sm:px-0 sm:py-0 md:px-0 md:py-0 ">
                      <div className="flex justify-center gap-2 sm:gap-1 sm:flex-col sm:gap-y-3  sm:items-center md:gap-1 md:flex-col md:gap-y-3  md:items-center ">
                        ...
                        <img
                          src={deleteIcon}
                          alt="edit icon"
                          className="mr-2 text-[#4E493E] hover:text-red-800 cursor-pointer sm:w-[20px] sm:mr-0 sm:ml-0 md:w-[20px] md:mr-0 md:ml-0"
                        />
                      </div>
                    </td>
                  </tr>
